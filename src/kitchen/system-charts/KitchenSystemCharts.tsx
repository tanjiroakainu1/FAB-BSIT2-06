...
export default function KitchenSystemCharts() {
  const { upsAndDowns, orders } = useAppData()
  const kitchenEntries = upsAndDowns.filter((e) => e.role === 'kitchen')
